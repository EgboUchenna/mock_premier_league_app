...
describe('Search Routes', function () {
    it('All users can search team robustly (eg using coach name)', function () {
        return supertest_1.default(app_1.default)
    ...
    it('All users can search team robustly using team name', function () {
        return supertest_1.default(app_1.default)
    ...
    it('All user can search team robustly using year founded', function () {
        return supertest_1.default(app_1.default)
    ...
    it('All users can search fixtures robustly using team name', function () {
        return supertest_1.default(app_1.default)
    ...
    it('returns invalid input if user input id not valid', function () {
        return supertest_1.default(app_1.default)
