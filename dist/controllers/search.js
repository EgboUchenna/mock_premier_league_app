...
exports.searchTeam = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, value, team, team, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, Team_1.Team.find({ founded: id })];
            case 2:
                team = _a.sent();
                if (team.length > 0) {
            ...
            case 3:
                ...
                return [4 /*yield*/, Team_1.Team.find().or([
                        { name: { $regex: value } },
                        { coach: { $regex: value } },
...
exports.searchFixture = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, value, fixtures, getFixtures, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
